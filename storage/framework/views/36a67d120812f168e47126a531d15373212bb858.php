...
<div class="container">
	...
	<div class='row'>	
		...
		<div class='col-md-4'>	
			<button type="button" class='btn btn-block btn-info' data-toggle='modal' data-target='#modal-produto'> Cadastro Rapido de <strong>Produtos</strong></button>
		</div>
		<div class='col-md-4'>	
			<?php if(count($clientes) > 0): ?>
				<?php if(count($produtos) > 0): ?>
			<button type="button" class='btn btn-block btn-warning' data-toggle='modal' data-target='#modal-pedido'> Cadastro Rapido de <strong>Pedidos</strong></button>
				<?php endif; ?>
			<?php else: ?>
			<p>
