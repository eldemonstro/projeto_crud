        ...
        <nav class="navbar navbar-default">
            <div class="container">
                ...
                <ul class='nav navbar-nav'>
                    <li ><a href="<?php echo $__env->yieldContent('path'); ?>/produtos">Produtos</a></li>
                    <li ><a href="<?php echo $__env->yieldContent('path'); ?>/clientes">Clientes</a></li>
                    <li ><a href="<?php echo $__env->yieldContent('path'); ?>/pedidos">Pedidos</a></li>
                </ul>
